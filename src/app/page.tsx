      ...
      <header className="w-full sticky top-0 z-30 bg-white/80 backdrop-blur border-b">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            ...
            <a href="#contacto" className="px-4 py-2 rounded-xl bg-neutral-900 text-white hover:opacity-90">Agendar diagnóstico</a>
          </nav>
        </div>
      </header>
        ...
        <div className="max-w-6xl mx-auto px-4 py-20 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="https://wa.me/5491125826179?text=Hola%20Marcelo%2C%20vengo%20desde%20la%20web%20y%20quiero%20agendar%20diagn%C3%B3stico" target="_blank" rel="noopener noreferrer" className="px-5 py-3 rounded-2xl bg-neutral-900 text-white hover:opacity-90">Agendar diagnóstico sin costo</a>
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="mt-8 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="rounded-3xl border p-6 bg-neutral-50">
              ...
              <a href="#contacto" className="inline-block mt-4 text-sm font-medium underline">Quiero este servicio</a>
            </div>
            {/* Honorarios */}
            <div className="rounded-3xl border p-6 bg-neutral-50">
              ...
              <a href="#contacto" className="inline-block mt-4 text-sm font-medium underline">Coordinemos un piloto</a>
            </div>
            {/* Cobro Ético */}
            <div className="rounded-3xl border p-6 bg-neutral-50">
              ...
              <a href="#contacto" className="inline-block mt-4 text-sm font-medium underline">Solicitar propuesta</a>
            </div>
          </div>
        </div>
      </section>
